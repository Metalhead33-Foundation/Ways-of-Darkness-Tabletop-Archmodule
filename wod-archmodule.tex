...
\newcommand{\FeatIRow}[2]{{#1} \\ \hline
{\resizebox{.2\linewidth}{!}{{#2}}} \\ \hline
}
\newcommand{\FeatIIRow}[4]{
\multicolumn{1}{|c}{\resizebox{.2\linewidth}{!}{{#3}}} & \multicolumn{1}{c}{\resizebox{.2\linewidth}{!}{{#4}}} \\ \hline
\multicolumn{1}{|c}{{#1}}        & \multicolumn{1}{c}{{#2}}  \\ \hline
}
\newcommand{\FeatIIIRow}[6]{
\multicolumn{1}{|c}{\resizebox{.2\linewidth}{!}{{#4}}} & \multicolumn{1}{c}{\resizebox{.2\linewidth}{!}{{#5}}} & \multicolumn{1}{c|}{\resizebox{.2\linewidth}{!}{{#6}}} \\ \hline
