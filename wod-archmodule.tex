...
\begin{tabularx}{0.75\textwidth}{c @{\extracolsep{\fill}} cc}
\hline
\multicolumn{3}{|c|}{Armour Conditioning} \\ \hline
\multicolumn{1}{|c}{\import{images/Feats/}{images/Feats/Armour1.pdf_tex}} & \multicolumn{1}{c}{\import{images/Feats/}{images/Feats/Armour2.pdf_tex}} & \multicolumn{1}{c|}{\import{images/Feats/}{images/Feats/Armour3.pdf_tex}} \\ \hline
\multicolumn{1}{|c}{Light}        & \multicolumn{1}{c}{Medium}       & \multicolumn{1}{c|}{Heavy}       \\ \hline
\end{tabularx}
%}
\end{table}
\begin{itemize}
...
\begin{tabularx}{0.75\textwidth}{c @{\extracolsep{\fill}} cc}
\hline
\multicolumn{3}{|c|}{Bladed Weapons} \\ \hline
\multicolumn{1}{|c}{\import{images/Feats/}{images/Feats/Blade1.pdf_tex}} & \multicolumn{1}{c}{\import{images/Feats/}{images/Feats/Blade2.pdf_tex}} & \multicolumn{1}{c|}{\import{images/Feats/}{images/Feats/Blade3.pdf_tex}} \\ \hline
\multicolumn{1}{|c}{Basic}        & \multicolumn{1}{c}{Advanced}       & \multicolumn{1}{c|}{Expert}       \\ \hline
\end{tabularx}
%}
\end{table}
\begin{itemize}
	\item \textbf{Untrained:} The character always deals minimal damage with bladed weapons, no need to roll the dice. They also get a \Malus{2} to Dexterity when it's being counted when using bladed weapons.
	\item \textbf{Basic:} The character suffers no bonuses or maluses when using bladed weapons.
	\item \textbf{Advanced:} The character reiceves a \Bonus{25\%} to all damage done by bladed weapons, and a \Bonus{25\%} to chance to hit or cause critical damage.
	\item \textbf{Expert:} The character reiceves a \Bonus{50\%} to all damage done by bladed weapons, and a \Bonus{50\%} to chance to hit or cause critical damage.
\end{itemize}
\subsection{Bows}
\begin{table}[!ht]
\centering
...
\begin{tabularx}{0.75\textwidth}{c @{\extracolsep{\fill}} cc}
\hline
\multicolumn{3}{|c|}{Bows} \\ \hline
\multicolumn{1}{|c}{\import{images/Feats/}{images/Feats/Ranged1.pdf_tex}} & \multicolumn{1}{c}{\import{images/Feats/}{images/Feats/Ranged2.pdf_tex}} & \multicolumn{1}{c|}{\import{images/Feats/}{images/Feats/Ranged3.pdf_tex}} \\ \hline
\multicolumn{1}{|c}{Basic}        & \multicolumn{1}{c}{Advanced}       & \multicolumn{1}{c|}{Expert}       \\ \hline
\end{tabularx}
%}
\end{table}
\begin{itemize}
	...
	\item \textbf{Basic:} The character suffers no bonuses or maluses when using ranged weapons.
