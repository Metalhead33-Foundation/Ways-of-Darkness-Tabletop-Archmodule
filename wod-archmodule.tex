...
\textbf{Effects:}
\begin{itemize}
	\item \textbf{Untrained:} You almost instantly get seasick the moment your ship disembarks.
	\item \textbf{Basic:} Dummy
	\item \textbf{Advanced:} Dummy
	\item \textbf{Expert:} Dummy
\end{itemize}\newpage
\subsection{Tracking}
\begin{table}[!ht]
\centering
...
\begin{itemize}
	...
	\item You choose between receiving Advanced Etiquette or Advanced Street Smarts for free
\end{itemize}
\textbf{Maluses:}
\begin{itemize}
	\item You can only choose 3 feats at the beginning, instead of the usual 6.
