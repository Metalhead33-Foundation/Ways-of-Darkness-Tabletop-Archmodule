...
\multicolumn{1}{|c}{{#5}} & \multicolumn{1}{c}{{#6}} & \multicolumn{1}{c|}{{#7}} \\ \hline
...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Bladed Weapons}{{\import{images/Feats/}{images/Feats/Blade1.pdf_tex}}}{{\import{images/Feats/}{images/Feats/Blade2.pdf_tex}}}{{\import{images/Feats/}{images/Feats/Blade3.pdf_tex}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
