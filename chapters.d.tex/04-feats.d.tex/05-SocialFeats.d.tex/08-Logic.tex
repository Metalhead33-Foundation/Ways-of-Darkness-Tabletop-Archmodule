...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Logic}{{\includegraphics[width=0.25\textwidth]{Feats/Logic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Logic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Logic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
