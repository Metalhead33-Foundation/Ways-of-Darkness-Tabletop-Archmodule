...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Diaesthese}{{\includegraphics[width=0.25\textwidth]{Feats/Diaesthese1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Diaesthese2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Diaesthese3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
