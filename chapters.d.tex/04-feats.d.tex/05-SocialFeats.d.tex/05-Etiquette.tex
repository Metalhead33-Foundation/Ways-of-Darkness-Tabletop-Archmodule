...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Etiquette}{{\includegraphics[width=0.25\textwidth]{Feats/Etiquette1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Etiquette2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Etiquette3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
