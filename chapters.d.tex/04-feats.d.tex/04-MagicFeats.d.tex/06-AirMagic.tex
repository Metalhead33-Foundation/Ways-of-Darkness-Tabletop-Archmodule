...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Aeromancy}{{\includegraphics[width=0.25\textwidth]{Feats/AirMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/AirMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/AirMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
