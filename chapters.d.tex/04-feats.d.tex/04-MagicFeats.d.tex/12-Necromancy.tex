...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Necromancy}{{\includegraphics[width=0.25\textwidth]{Feats/DeathMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DeathMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DeathMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
