...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Sciomancy}{{\includegraphics[width=0.25\textwidth]{Feats/DarkMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DarkMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DarkMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
