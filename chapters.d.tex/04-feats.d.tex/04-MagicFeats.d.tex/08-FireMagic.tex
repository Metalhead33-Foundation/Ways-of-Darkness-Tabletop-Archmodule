...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Pyromancy}{{\includegraphics[width=0.25\textwidth]{Feats/FireMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/FireMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/FireMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
