...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Hydromancy}{{\includegraphics[width=0.25\textwidth]{Feats/WaterMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/WaterMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/WaterMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
