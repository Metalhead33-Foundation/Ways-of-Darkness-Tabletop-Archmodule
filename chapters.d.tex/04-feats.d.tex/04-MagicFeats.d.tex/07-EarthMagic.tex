...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Geomancy}{{\includegraphics[width=0.25\textwidth]{Feats/EarthMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/EarthMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/EarthMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
