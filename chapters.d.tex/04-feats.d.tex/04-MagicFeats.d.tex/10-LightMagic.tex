...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Photomancy}{{\includegraphics[width=0.25\textwidth]{Feats/LightMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/LightMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/LightMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
