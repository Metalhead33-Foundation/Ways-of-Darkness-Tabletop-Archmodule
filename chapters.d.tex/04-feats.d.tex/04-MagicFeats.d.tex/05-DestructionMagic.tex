...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Olethromancy}{{\includegraphics[width=0.25\textwidth]{Feats/DestructionMagic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DestructionMagic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/DestructionMagic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
