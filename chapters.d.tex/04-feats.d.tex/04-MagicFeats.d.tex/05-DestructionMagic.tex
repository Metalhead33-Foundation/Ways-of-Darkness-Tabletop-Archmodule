...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Olethromancy}{{\includegraphics{Feats/DestructionMagic1}}}{{\includegraphics{Feats/DestructionMagic2}}}{{\includegraphics{Feats/DestructionMagic3}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
