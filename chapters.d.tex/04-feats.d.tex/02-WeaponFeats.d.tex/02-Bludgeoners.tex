...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Bludgeoners}{{\includegraphics[width=0.25\textwidth]{Feats/Blunt1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Blunt2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Blunt3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
