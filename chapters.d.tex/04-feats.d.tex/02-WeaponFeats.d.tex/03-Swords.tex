...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Swords}{{\includegraphics[width=0.25\textwidth]{Feats/Blade1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Blade2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Blade3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
