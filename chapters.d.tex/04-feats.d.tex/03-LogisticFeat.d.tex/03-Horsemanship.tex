...
\begin{table}[!ht]
\centering
\FeatII{Advanced}{Expert}{Horsemanship}{{\includegraphics[width=0.25\textwidth]{Feats/Horsemanship1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Horsemanship2.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
