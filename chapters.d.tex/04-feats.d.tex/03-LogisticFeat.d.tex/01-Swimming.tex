...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Swimming}{{\includegraphics[width=0.25\textwidth]{Feats/Swimming1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Swimming2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Swimming3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
