...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Arithmetics}{{\includegraphics[width=0.25\textwidth]{Feats/Arithmetic1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Arithmetic2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Arithmetic3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
