...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Alchemy}{{\includegraphics[width=0.25\textwidth]{Feats/Alchemy1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Alchemy2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Alchemy3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
