...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Smuggling}{{\includegraphics[width=0.25\textwidth]{Feats/Smuggling1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Smuggling2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Smuggling3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
