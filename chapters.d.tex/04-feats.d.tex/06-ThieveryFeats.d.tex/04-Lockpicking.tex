...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Lockpicking}{{\includegraphics[width=0.25\textwidth]{Feats/Lockpicking1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Lockpicking2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Lockpicking3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
