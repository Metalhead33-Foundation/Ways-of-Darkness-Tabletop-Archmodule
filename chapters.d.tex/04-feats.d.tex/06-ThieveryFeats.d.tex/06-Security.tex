...
\begin{table}[!ht]
\centering
\FeatIII{Basic}{Advanced}{Expert}{Security}{{\includegraphics[width=0.25\textwidth]{Feats/Security1.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Security2.pdf}}}{{\includegraphics[width=0.25\textwidth]{Feats/Security3.pdf}}}
\end{table}
\textbf{Requirements:}
\begin{itemize}
